...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "hincoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"ams1.hincoin.org", "ams1.hincoin.org"},
    {"ams2.hincoin.org", "ams2.hincoin.org"},
    {"ams3.hincoin.org", "ams3.hincoin.org"},
    {"ams4.hincoin.org", "ams4.hincoin.org"},
    {"nl1.hincoin.org", "nl1.hincoin.org"},
    {"nl2.hincoin.org", "nl2.hincoin.org"},
    {"se1.hincoin.org", "se1.hincoin.org"},
    {"vtc.kilovolt.co.uk", "vtc.kilovolt.co.uk"},
    {"ny.hincoin.org", "ny.hincoin.org"},
    {"la.hincoin.org", "la.hincoin.org"},
    {"eu.hincoin.org", "eu.hincoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.hincoin.org", "testnet-seed.hincoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. hincoin is probably already running."), addrBind.ToString().c_str());
        else
